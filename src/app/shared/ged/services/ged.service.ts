...
export class GedService extends ServiceBase {
    ...
    arquivoPropertiesGet(id: number): Observable<ApiResponse<ArquivoView>> {
        return this.http.get<ApiResponse<ArquivoView>>(`${this.apisUtilsService.getApiUrl(TMicroService.ApiGed)}/Arquivo/ArquivoPropertiesGet/${id}`)
    ...
    pastaPropertiesGet(id: number, rootId?: number): Observable<ApiResponse<PastaView>> {
        ...
        return this.http.get<ApiResponse<PastaView>>(`${this.apisUtilsService.getApiUrl(TMicroService.ApiGed)}/Arquivo/PastaPropertiesGet/${id}/${userId}`, { params })
            .pipe(catchError(this.handleError))
    }
    ...
    pastaCaminhoGet(id: number, rootId: number): Observable<ApiResponse<string>> {
        ...
        return this.http.get<ApiResponse<string>>(`${this.apisUtilsService.getApiUrl(TMicroService.ApiGed)}/Arquivo/PastaCaminhoGet/${id}`, { params })
            .pipe(catchError(this.handleError))
    }
    ...
    pastaIdGet(codigo: string): Observable<ApiResponse<number | undefined>> {
        ...
        return this.http.get<ApiResponse<number | undefined>>(`${this.apisUtilsService.getApiUrl(TMicroService.ApiGed)}/Arquivo/PastaIdGet/${cadastroId}/${codigo}`)
            .pipe(catchError(this.handleError))
    }

    pastaCadastroIdGet(cadastroId: number): Observable<ApiResponse<number | undefined>> {
        return this.http.get<ApiResponse<number | undefined>>(`${this.apisUtilsService.getApiUrl(TMicroService.ApiGed)}/Arquivo/PastaCadastroIdGet/${cadastroId}`)
            .pipe(catchError(this.handleError))
    }
    ...
    arquivoDownload(id: number): Observable<Blob> {
        ...
        return this.http.get(`${this.apisUtilsService.getApiUrl(TMicroService.ApiGed)}/Arquivo/ArquivoDownload/${id}/${userId}`, { responseType: 'blob' })
            .pipe(catchError(this.handleError));
    }

    arquivoTipoApontamentoUpload(funcionarioId: number, apontamentoId: number, apontamentoData: string, commentId: number, files: File[]): Observable<ApiResponse<number | undefined>> {
        ...
        return this.http.post<ApiResponse<number | undefined>>(`${this.apisUtilsService.getApiUrl(TMicroService.ApiGed)}/Arquivo/ArquivoFormUpload`, formData)
            .pipe(catchError(this.handleError))
    }

    arquivoTipoAtestadoUpload(funcionarioId: number, apontamentoId: number, apontamentoData: string, files: File[]): Observable<ApiResponse<number | undefined>> {
    ...
    arquivoTipoObrigacaoUpload(clienteId: number, obrigacaoClientePeriodoId: number, prazo: string, vencimento: string | undefined,
        competenciaMes: string | undefined, competenciaAno: number | undefined,
        commentId: number, files: File[]): Observable<ApiResponse<number | undefined>> {
        ...
        if (vencimento)
            formData.append('obrigacaoVencimento', vencimento);

        if (competenciaMes)
            formData.append('competenciaMes', competenciaMes);

        if (competenciaAno)
            formData.append('competenciaAno', competenciaAno.toString());
    ...
    planoContasPagingGet(cadastroId: number, pastaId: number): Observable<ApiResponse<Paging<PastaPageItem>>> {
        ...
        return this.http.get<ApiResponse<number | undefined>>(`${this.apisUtilsService.getApiUrl(TMicroService.ApiGed)}/Arquivo/PlanoContasPagingGet/${cadastroId}/${userId}`, { params })
            .pipe(catchError(this.handleError))
    }
