...
export class PercentageBarComponent {
    ...
    getDefaultClass(): string {
        ...
        if (this.multiColor) {
            ...
            return (this.bordered ? this._getBorderClass(this.defaultBackgroundColor ?? this.backgroundColor) : this._getDefaultClass(this.defaultBackgroundColor ?? this.backgroundColor))
        }
    }
    ...
    private _getBackgroundClass(backgroundColor: string): string {
        switch (backgroundColor) {
            case "blue": return 'bg-blue-500 dark:bg-blue-700'
            case "red": return 'bg-red-500 dark:bg-red-700'
            case "green": return 'bg-green-500 dark:bg-green-700'
            case "yellow": return 'bg-yellow-500 dark:bg-yellow-700'
            default: return ''
        }
    }
    ...
    private _getBorderClass(backgroundColor: string): string {
        switch (backgroundColor) {
            case "blue": return 'border border-blue-300 dark:border-blue-800'
            case "red": return 'border border-red-300 dark:border-red-800'
            case "green": return 'border border-green-300 dark:border-green-800'
            case "yellow": return 'border border-yellow-300 dark:border-yellow-800'
            default: return ''
        }
    }
