...
@Component({
    selector: 'clientes-obrigacoes-atrasadas-geral-widget',
    templateUrl: './clientes-obrigacoes-atrasadas-geral-widget.html',
    host: { class: 'h-[430px]' },
    imports: [WidgetComponent, PercentageBarComponent],
})
export class ClientesObrigacoesAtrasadasGeralWidgetComponent implements OnInit {
