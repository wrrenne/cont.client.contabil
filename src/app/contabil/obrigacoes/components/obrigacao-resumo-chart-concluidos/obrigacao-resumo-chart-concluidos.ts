...
@Component({
    selector: 'obrigacao-resumo-chart-concluidos',
    templateUrl: './obrigacao-resumo-chart-concluidos.html',
    styleUrls: ['./obrigacao-resumo-chart-concluidos.scss'],
    host: { class: 'relative top-[-9px]' },
    imports: [ChartComponent],
})
export class ObrigacaoResumoChartConcluidosComponent {
    ...
    initCharts() {
        ...
        const rawData = [{ category: 'Conclusão', value: this.obrigacoesStat.concluidoPorcento }];
