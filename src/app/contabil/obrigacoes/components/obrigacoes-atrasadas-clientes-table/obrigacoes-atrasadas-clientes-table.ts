...
import { ObrigacoesAtrasadasClientesPagingService } from '../../services/pagings/obrigacoesAtrasadasClientes.service';
...
export class ObrigacoesAtrasadasClientesTableComponent extends PagingBase<ContabilClientePageItem> implements OnInit {
    ...
    constructor(
        ...
        super(injector, obrigacoesAtrasadasClientesPagingService);
