...
@Component({
    selector: 'obrigacao-resumo-chart',
    templateUrl: './obrigacao-resumo-chart.html',
    styleUrls: ['./obrigacao-resumo-chart.scss'],
    host: { class: 'h-[320px]' },
    imports: [ChartComponent],
})
export class ObrigacaoResumoChartComponent {
    ...
    //    // Filter out zero values
    //    const rawData = [
    //        { category: "Conclusão", value: this.obrigacoesStat.concluidasNoPrazo },
    //        { category: "Atraso", value: this.obrigacoesStat.concluidasForaDoPrazo },
    //        { category: "Atrasado", value: this.obrigacoesStat.emAtraso },
    //        { category: "Aberto", value: this.obrigacoesStat.emAberto },
    //    ];
